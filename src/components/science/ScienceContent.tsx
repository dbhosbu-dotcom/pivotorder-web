    ...
    <main style={{ backgroundColor: '#FFFFFF', minHeight: 'calc(100vh - 68px)' }}>
      ...
      <section style={{
        ...
        <div style={{
          ...
          borderRadius: '20px', padding: '7px 16px', marginBottom: '32px',
        }}>
          {/* Badge label — bumped to 0.8125rem for Chinese readability */}
          <span style={{
        ...
        <h1 style={{
          ...
          color: 'var(--color-text-heading)', lineHeight: 1.08,
      ...
      <section style={{ padding: 'clamp(64px,8vw,104px) 24px', maxWidth: '1100px', margin: '0 auto' }}>
        ...
        {/* Section label — was 0.6875rem mono caps, now proper readable size */}
          ...
          {t.science.pillars.map((p, i) => (
            <div
              ...
              style={{
                ...
                borderBottom: i === t.science.pillars.length - 1 ? '1px solid var(--color-border)' : 'none',
              }}
            >
              <div>
                <span style={{
              ...
              <div>
                ...
                {/* Stats row — labels were 0.6875rem, now 0.8125rem */}
                <div style={{ display: 'flex', gap: '36px', flexWrap: 'wrap', marginBottom: '20px' }}>
                  {PILLAR_STATS[i].map((s) => (
                    <div key={s.label}>
                      ...
                      <div style={{
                        fontSize: '0.8125rem',      /* was 0.6875rem */
                        color: 'var(--color-text-secondary)',
                        marginTop: '4px',
                        lineHeight: 1.4,
                      }}>
      ...
      <section style={{
        ...
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          ...
          {/* Pipeline section label — was 0.6875rem mono, now 0.9375rem */}
            ...
            {t.science.pipeline_steps.map((s, i) => (
              ...
              >
                ...
                <div style={{
                  ...
                  {/* Step number — decorative, small is fine */}
                  <span style={{
                    fontFamily: 'var(--font-mono)',
                ...
                <div style={{ paddingTop: '8px' }}>
                  {/* Step label — was 0.9375rem, keep */}
                  <div style={{
                    fontWeight: 600, fontSize: '1rem',
                    color: 'var(--color-text-heading)', marginBottom: '4px',
                    lineHeight: 1.4,
                  }}>
                    {s.label}
                  </div>
                  {/* Step description — was 0.75rem mono, now 0.875rem sans */}
                  <div style={{
                    fontSize: '0.875rem',
                    color: 'var(--color-text-secondary)',
                    lineHeight: 1.7,
